...
export default function TransactionBanner() {
    ...
    function WithdrawComponent() {
        ...
        return (
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                <ModalOverlay />
                <ModalContent h="320px" w={["300px", "300px", "300px", "504px"]}>
                    <ModalHeader justifyContent="flex-start" fontSize="20px" fontWeight="500" alignItems="center">Fund Token</ModalHeader>
                    <ModalBody w="full">
                        <Formik
                            initialValues={data}
    ...
    return (
        <>
            {WithdrawComponent()}
            <Center justifyContent="space-between" w="full" h="129px" mt="16px" bg={COLORS.blue} borderRadius="8px" pl="10px" pr="20px">
                <Center>
                    <Img src="/payout/money.png" />
                    <Box>
