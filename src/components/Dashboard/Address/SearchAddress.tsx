        ...
        <Box p={["20px", "20px", "20px", "30px"]} pt="0px">
            <Center h={["auto", "auto", "auto", "89px"]} flexDir={["column", "column", "column", "row"]} p={["20px", "20px", "20px", "30px"]} justifyContent={"start"} borderRadius="8px" w="full" bg={COLORS.white}>
                <Center bg="#f9f9f9" mb="10px" w={"full"} borderRadius="16px" pl="5px" pr="5px" h="40px">
                    ...
                    <Input focusBorderColor='transparent' placeholder='Search for people or phone numbers' ml="5px" borderColor="transparent" />
                </Center>
                <Center w="full">
                    <Select mb="10px" placeholder='LGA' mr={"15px"} ml={["0px", "0px", "0px", "15px"]} w={["full", "full", "full", "164px"]}>
                        <option value='option1'>Option 1</option>
                        <option value='option2'>Option 2</option>
                        <option value='option3'>Option 3</option>
                    </Select>
                    <Select mb="10px" placeholder='State' mr={["0px", "0px", "0px", "15px"]} w={["full", "full", "full", "164px"]}>
                        <option value='option1'>Option 1</option>
                        <option value='option2'>Option 2</option>
                        <option value='option3'>Option 3</option>
                    </Select>
                </Center>
                <Button mb="10px" bg="#7ED31F" w="146.97px" h="42.19px" color={COLORS.white} colorScheme='green'>
                    Search
                </Button>
            </Center>
        </Box>
