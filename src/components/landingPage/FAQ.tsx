                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div className="card index3_card">
                                    ...
                                    <div className="card_pagee" role="tab" id="headingTwo3">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapseTwo" role="button"
                                                aria-expanded="false" aria-controls="collapseTwo">
                                                Is there any charges for withdrawal?
                                            </a>
                                        </h5>
                                    </div>

                                    <div id="collapseTwo" className="collapse" role="tabpanel" aria-labelledby="headingTwo3"
                                        data-parent="#accordion" >
                                        <div className="card-body">

                                            <div className="card_cntnt">
                                                <p>Yes Just {cashFormat(100)}</p>
                                            </div>
                                        </div>
                                    </div>
