            ...
            <Container maxW="container.xl">
                <SimpleGrid columns={[1, 2, 4]} spacing={10} mb={12}>
                    <VStack align="start" spacing={6}>
                        ...
                        <Text color="gray.600" fontSize="sm">
                            ...
                            Empowering agents to grow and earn together.
                        </Text>
                    </VStack>
                    ...
                    <VStack align="start" spacing={4}>
                        ...
                        <VStack align="start" spacing={2}>
                            ...
                            <Link fontSize="sm" color="gray.600" href="#">Agent Agreement</Link>
                        </VStack>
                    </VStack>
                    ...
                    <VStack align="start" spacing={4}>
                        ...
                        <VStack align="start" spacing={2}>
                            <Link fontSize="sm" color="gray.600" href="#">About ABN Agents</Link>
                ...
                <HStack justify="space-between" wrap="wrap" spacing={4}>
                    <Text fontSize="xs" color="gray.500">
                        © 2026 ABN Agents. All rights reserved.
                    </Text>
                    <HStack spacing={6}>
